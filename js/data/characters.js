...
//  플레이 가능한 캐릭터 4종
//
//  시작 체력은 v1.5.9 에서 넷 다 10씩 올렸다 (80/70/75/72 → 90/80/85/82).
//  조금 더 여유 있게 즐기자는 쪽으로 난이도를 낮춘 것이다 — 시작 보너스를
//  둘 고르게 한 것(neow.js)과 같은 판에서 함께 바꿨다.
// ============================================================
export const CHARACTERS = {
  ironclad: {
    id: 'ironclad', name: '아이언클래드', en: 'Ironclad', color: 'red',
    maxHp: 90, gold: 99, relic: 'burningBlood',
  ...
  silent: {
    ...
    maxHp: 80, gold: 99, relic: 'ringOfTheSnake',
  ...
  defect: {
    ...
    maxHp: 85, gold: 99, relic: 'crackedCore', orbSlots: 3,
  ...
  watcher: {
    ...
    maxHp: 82, gold: 99, relic: 'pureWater',
